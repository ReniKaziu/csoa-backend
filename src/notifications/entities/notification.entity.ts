...
export enum NotificationType {
  ...
  CREATOR_EXCLUDED_FROM_EVENT = "creator excluded you from event",
  ...
  TEAM_CREATOR_CREATED_EVENT = "team creator created event",
  TEAM_EXCLUDED_FROM_EVENT = "team excluded from team",
  TEAM_LEFT_EVENT = "team left event",
